...
import { PalletRepositoryImpl } from '../../../infrastructure/db/frios/mssql/PalletRepositoryImpl';
import { ObtenerPalletsService } from '../../../application/frios/services/movementsOfTheMonth.services';
